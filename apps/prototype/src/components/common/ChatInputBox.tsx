        ...
        <div className="relative min-w-0 flex-1 flex flex-row items-end justify-start p-0">
          <div className="min-w-0 flex-1 flex flex-row items-start justify-start min-h-6 p-0">
            <div
              ...
              className="chat-input min-w-0 max-w-full bg-transparent pl-2 text-foreground text-base font-normal leading-5 outline-none resize-none custom-scrollbar min-h-5 max-h-[400px] w-full block break-words whitespace-pre-wrap empty:before:content-[attr(data-placeholder)] empty:before:text-muted-foreground"
