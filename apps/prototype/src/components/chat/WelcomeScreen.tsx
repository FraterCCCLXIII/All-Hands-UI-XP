...
import { UxFlowSparkleMenu } from './UxFlowSparkleMenu';
import {
  Dialog,
  DialogContent,
  DialogHeader,
          ...
          <Popover>
            ...
            <div className="flex flex-col gap-3">
              <div className="space-y-1.5 pb-2 border-b border-border">
                <p className="text-xs font-semibold text-muted-foreground">Chat page</p>
                <button
                  type="button"
                  onClick={() => {
                ...
                >
                  Blank new conversation (canvases off, title unset)
                </button>
              </div>
