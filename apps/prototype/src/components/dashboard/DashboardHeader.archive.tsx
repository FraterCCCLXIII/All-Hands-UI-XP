...
export type ArchivedDashboardTabId = 'kanban' | 'active' | 'reviews';

interface ArchivedDashboardHeaderProps {
  activeTab: ArchivedDashboardTabId;
  onSelectTab: (tabId: ArchivedDashboardTabId) => void;
}
...
export function ArchivedDashboardHeader({ activeTab, onSelectTab }: ArchivedDashboardHeaderProps) {
  return (
