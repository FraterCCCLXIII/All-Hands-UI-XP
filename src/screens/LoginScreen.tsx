...
const socialLogins = [
  { id: 'github', label: 'Login with Github', icon: Github, className: 'bg-[#9E28B0] hover:bg-[#8a2399] text-white border-0' },
  { id: 'gitlab', label: 'Login with Gitlab', icon: GitLabIcon, className: 'bg-[#FC6B0E] hover:bg-[#e55f0c] text-white border-0' },
  { id: 'bitbucket', label: 'Login with Bitbucket', icon: BitbucketIcon, className: 'bg-[#2684FF] hover:bg-[#1a6ce6] text-white border-0' },
  { id: 'google', label: 'Login with Google', icon: GoogleIcon, className: 'bg-white hover:bg-gray-100 text-gray-800 border border-border' },
];
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-0 bg-background text-foreground px-6 py-12">
      <div className="w-full max-w-sm flex flex-col items-center gap-8">
        ...
        <div className="w-full flex flex-col gap-3">
          {socialLogins.map(({ id, label, icon: Icon, className }) => (
            <button
              key={id}
              type="button"
