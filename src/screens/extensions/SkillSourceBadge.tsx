...
export function SkillSourceBadge({ source, className }: SkillSourceBadgeProps) {
  return (
    <span
      className={cn(
        'inline-flex max-w-full shrink-0 items-center rounded border border-border bg-muted/60 px-1.5 py-px text-[10px] font-medium uppercase tracking-wide text-muted-foreground',
        className
      )}
    >
