...
const GitLabIcon = ({ className }: { className?: string }) => (
  <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    <g clipPath="url(#clip0_gitlab_logo)">
...
interface LogoDropdownContentProps {
  onNavToNewUserExperience?: () => void;
  onEnterpriseLearnMoreClick?: () => void;
}

export function LogoDropdownContent({ onNavToNewUserExperience, onEnterpriseLearnMoreClick }: LogoDropdownContentProps) {
